 ...
 * @date 2020-02-25
 */
public class ZxDeptInfo extends BaseEntity
{
    ...
    /** 标段号 */
    @Excel(name = "标段号")
    private String projectSecNum;


    /** 结构层 */
    @Excel(name = "结构层")
    private String projectStructuralLayer;
    ...
    public String getProjectSecNum() {
        return projectSecNum;
    }

    public void setProjectSecNum(String projectSecNum) {
        this.projectSecNum = projectSecNum;
    }

    public String getProjectStructuralLayer() {
        return projectStructuralLayer;
    }

    public void setProjectStructuralLayer(String projectStructuralLayer) {
        this.projectStructuralLayer = projectStructuralLayer;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("projectInfo", getProjectInfo())
                .append("projectMileage", getProjectMileage())
                .append("projectSecNum", getProjectSecNum())
                .append("projectStructuralLayer", getProjectStructuralLayer())
                .append("projectInfo", getProjectInfo())
